  ...
  async acquireTokenRedirect(request) {
    ...
    if (onRedirectNavigateCb) {
      request.onRedirectNavigate = (url) => {
        ...
        atrMeasurement.event = atrMeasurement.end({ success: true }) || atrMeasurement.event;
        return navigate;
      };
    } else {
    ...
    try {
      ...
      if (atrMeasurement.event.status === 2) {
        this.performanceClient.startMeasurement(PerformanceEvents.AcquireTokenRedirect, correlationId).end({ success: false }, e);
      } else {
...
*/
//# sourceMappingURL=chunk-INTJIPLY.js.map
